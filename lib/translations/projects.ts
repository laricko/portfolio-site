...
export const projects: ProjectData[] = [
  {
    ...
    useCases: {
      ...
      ru: [
        ...
        "Анализ репозиториев для создания микросервисных узлов",
        "Назначение пользователей к микросервисам на основе их ролей",
      ],
    },
    achievements: {
      en: [
      ...
      ru: [
        "Полностью спроектировал бэкенд по Clean Architecture для ключевых модулей",
        "Интегрировал GitHub App для работы с репозиториями",
        "Подключил OpenAI для анализа микросервисов",
        "Сделал эндпоинты дашбордов и таблиц лидеров",
        "Реализовал логику организаций, пользователей и ролей",
        "Настроил контейнерные сервисы и CI/CD",
      ],
    },
    myRole: {
      en: [
      ...
      ru: [
        "CEO и ведущий архитектор бэкенда",
